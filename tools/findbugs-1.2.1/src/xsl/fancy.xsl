...
<xsl:transform xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
                                        ...
                                        <div class="b-r">
                                            <a>
                                                <xsl:attribute name="href">
                                                    <xsl:value-of select="$htmlsrcpath"/>
    ...
    <xsl:template name="display-bug">
        ...
        <div class="bb">
            <a>
                ...
                <xsl:attribute name="onclick">showbug('b-uid-
                    <xsl:value-of select="@instanceHash"/>
                    -
                    <xsl:value-of select="@instanceOccurrenceNum"/>
                    ','
                    <xsl:value-of select="$which-list"/>
                    ');return false;
                </xsl:attribute>
                <span>
                    <xsl:attribute name="class">b-
    ...
    <xsl:template name="categories">
        ...
        <div class='ob'>
            <div class='ob-t'>
                <a>
                    <xsl:attribute name="href"></xsl:attribute>
                    <xsl:attribute name="onclick">toggle('category-
            ...
            <div style="display:none;">
                <xsl:attribute name="id">category-
                    <xsl:value-of select="$category"/>
                </xsl:attribute>
    ...
    <xsl:template name="list-by-category-and-code">
        ...
        <xsl:variable name="unique-code"
                      select="/BugCollection/BugInstance[@category=$category and generate-id()= generate-id(key('lbc-code-key',concat(@category,@abbrev)))]/@abbrev"/>
    ...
    <xsl:template name="list-by-category-and-code-and-bug">
        ...
        <xsl:variable name="unique-bug"
                      select="/BugCollection/BugInstance[@category=$category and @abbrev=$code and generate-id()= generate-id(key('lbc-bug-key',concat(@category,@abbrev,@type)))]/@type"/>
        ...
        <div class='ib-2'>
            <div class='ib-2-t'>
                <a>
                    ...
                    <xsl:attribute name="onmouseout">popUp(event,'tip-
                        <xsl:value-of select="$bug"/>
                        ');
                    </xsl:attribute>
                    <xsl:attribute name="onmouseover">popUp(event,'tip-
                        <xsl:value-of select="$bug"/>
                        ');
                    </xsl:attribute>
                    <xsl:value-of
            ...
            <div style="display:none;">
                ...
                <xsl:variable name="cat-code-type">category-
                    <xsl:value-of select="$category"/>
                    -and-code-
                    <xsl:value-of select="$code"/>
                    -and-bug-
                ...
                <xsl:variable name="bug-id">b-uid-
                    <xsl:value-of select="@instanceHash"/>
                    -
                    <xsl:value-of select="@instanceOccurrenceNum"/>
                </xsl:variable>
    ...
    <xsl:template name="packages">
        ...
        <xsl:variable name="package-count-p1">
            <xsl:if test="not(/BugCollection/FindBugsSummary/PackageStats[@package=$package]/@priority_1 != '')">0
            </xsl:if>
        ...
        <xsl:variable name="package-count-p2">
            <xsl:if test="not(/BugCollection/FindBugsSummary/PackageStats[@package=$package]/@priority_2 != '')">0
            </xsl:if>
        ...
        <xsl:variable name="package-count-p3">
            <xsl:if test="not(/BugCollection/FindBugsSummary/PackageStats[@package=$package]/@priority_3 != '')">0
            </xsl:if>
        ...
        <xsl:variable name="package-count-p4">
            <xsl:if test="not(/BugCollection/FindBugsSummary/PackageStats[@package=$package]/@priority_4 != '')">0
            </xsl:if>
        ...
        <div class='ob'>
            <div class='ob-t'>
                <a>
                    <xsl:attribute name="href"></xsl:attribute>
                    <xsl:attribute name="onclick">toggle('package-
                        <xsl:value-of select="$package"/>
                        ');return false;
                    </xsl:attribute>
                    <xsl:value-of select="$package"/>
    ...
    <xsl:template name="list-by-package-and-class-and-bug">
        ...
        <xsl:variable name="unique-class-bugs"
                      select="/BugCollection/BugInstance[Class[position()=1 and @classname=$class] and generate-id() = generate-id(key('lbp-class-b-t',concat(Class/@classname,@type)))]/@type"/>
    ...
    <xsl:template name="class-bugs">
        ...
        <div class='ib-2'>
            ...
            <div style="display:none;">
                ...
                <xsl:for-each
                        select="/BugCollection/BugInstance[@type=$type and Class[position()=1 and @classname=$class]]">
                    <xsl:call-template name="display-bug">
                        <xsl:with-param name="b-t" select="@type"/>
                        <xsl:with-param name="bug-id" select="$bug-id"/>
